...
import br.com.java.exploringrestwithspringboot.Security.JWT.JwtConfigurer;
...
public class SecurityConfig {
    ...
    @Bean
    AuthenticationManager authenticationManagerBean(@NotNull AuthenticationConfiguration authenticationConfiguration) throws Exception {
